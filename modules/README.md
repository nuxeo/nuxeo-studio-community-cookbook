...
--- | --- | --- | ---
<a href="https://github.com/nuxeo/nuxeo-studio-custom-elements/blob/master/modules/nuxeo/workflow-status"><img src="nuxeo/workflow-status/workflow-status.png" height="60px"/></a> | Monitor workflow instances status displayed in the "Analytics" area of Web UI. | Nuxeo | Workflow
